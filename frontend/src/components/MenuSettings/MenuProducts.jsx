...
function MenuProducts() {
    ...
    function saveProduct() {
        ...
        const condiment = document.getElementById("ProductCondiment").value
        const newProduct = {
            name: name,
    ...
    function editProduct(index){
        ...
        console.log("taxindex",taxIndex,document.getElementById("ProductTax").options)
    ...
    return <div className={styles["content-container"]}>
        ...
        <div className={styles["product-container"]}>
            ...
            {products?.map((product, index) => (
                (
                    <div key={index} className={styles["menu-items"]}>
                        <p className={styles["product-name"]}>{product.name}</p>
                        <p className={styles["product-category"]}>{product.category}</p>
                        <p className={styles["product-condiment-groups"]}>{product.condiment}</p>
        ...
        <div className={staticStyles["input-container"]}>
            ...
            <div className={staticStyles["two-form"]}>
                ...
                <div className={staticStyles["form"]}>
                    <p>İlave Grup Ekle</p>
                    <input type="text" placeholder="İLAVE GRUP" name="" id="ProductCondiment" />
                </div>
