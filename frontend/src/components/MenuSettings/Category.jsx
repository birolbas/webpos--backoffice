...
function Category() {
    ...
    function saveSubCategory() {
        ...
        tempUpperCategories[newSubCategoryIndex].subCategories.push(newSubCategoryName)
                    ...
                    {upperCategories.map((category, upperIndex) => (
                        <div className={styles["category-species"]} >
                            <div className={styles["category"]} >
                                ...
                                <div style={{ display: "flex" }}> <svg onClick={() => { setIsNewSubCategoryInput(true), setNewSubCategoryIndex(upperIndex) }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
        ...
        {isNewCategoryInput ? (
            <div className={staticStyles["input-container"]}>
                ...
                <div className={staticStyles["action-buttons"]}>
                    ...
                    <button onClick={() => saveUpperCategory()}>Kaydet</button>
                </div>
            </div>
        ) : ""
        }
