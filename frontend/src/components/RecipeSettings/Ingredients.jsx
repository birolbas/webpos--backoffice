...
function Ingredients() {
    ...
    return <div className={staticStyles["content-container"]}>
        <div className={staticStyles["info-container"]}>
            ...
            <div id='input' className={style["input-container"]}>
                <h1 className={style["ingredient-input-header"]}>Yeni Malzeme</h1>
                <div style={{ gridTemplateColumns: "1.5fr 1fr 1fr 1fr 1fr 0.5fr 1fr    " }} className={style["input"]}>
                    <div className={IngredientsCSS["ingredient-name"]} >
                        <label htmlFor="">Malzeme Adı</label>
                    ...
                    <div className={IngredientsCSS["ingredient-cost"]}>
                        <label htmlFor="">Stok Miktarı</label>
                        <input type="number" name="" id="" />
                    </div>
                    <div className={IngredientsCSS["ingredient-unit"]}>
                        <label htmlFor="">Stok Kontrolü</label>
                        <select id="unit" required defaultValue="">
                            <option value="KG">KG</option>
                            <option value="Litre">Litre</option>
                            <option value="Piece">Adet</option>
                    ...
                    <div className={IngredientsCSS["ingredient-cost"]}>
                        <label htmlFor="">Maliyet</label>
                        <input type="number" name="" id="" />
                    </div>                   

                    <div className={IngredientsCSS["ingredient-cost"]}>
                        <label htmlFor="">Fatura İsimleri</label>
                        <input type="text" />
                    </div>
                </div>
            ...
            <div className={style["ingredients-container"]}>
                ...
                <div style={{ gridTemplateColumns: "1.5fr 1fr 1fr 1fr 1fr 0.5fr 0.5fr 0.5fr 0.5fr" }} className={staticStyles["table-header-style"]}>
                    <p>Ürün Adı</p>
                    <p>Kategori</p>
                    <p>Birim</p>
                    <p>Stoktaki Miktar</p>
                ...
                <div id='input-container' className={IngredientsCSS["input-container"]}>
                    <div className={IngredientsCSS["ingredient-container"]} >
                        {ingredients.map((ingredient, index) => (
                            <div style={{ gridTemplateColumns: "1.5fr 1fr 1fr 1fr 1fr 0.5fr 0.5fr 0.5fr 0.5fr" }} className={IngredientsCSS["ingredient"]}>
